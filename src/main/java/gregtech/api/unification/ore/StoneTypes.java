...
public class StoneTypes {
    ...
    public static final StoneType NETHERRACK = new StoneType(6, "netherrack", new ResourceLocation("blocks/netherrack"), SoundType.STONE, OrePrefix.oreNetherrack, Materials.Netherrack, "pickaxe", 0,
        Blocks.NETHERRACK::getDefaultState,
        state -> state.getBlock() == Blocks.NETHERRACK);

    public static final StoneType ENDSTONE = new StoneType(7, "endstone", new ResourceLocation("blocks/end_stone"), SoundType.STONE, OrePrefix.oreEndstone, Materials.Endstone, "pickaxe", 0,
    ...
    static {
        int id = 10; // Following RED_SANDSTONE's ID
        for (Rock rock : TFCRegistries.ROCKS) {
            ...
            for (Rock.Type type : new Rock.Type[] { Rock.Type.GRAVEL, Rock.Type.SAND, Rock.Type.RAW }) {
                nestedMap.put(type, new StoneType(
                        id++,
                        rock.toString() + type.toString(),
                        new ResourceLocation(TerraFirmaCraft.MOD_ID, "blocks/stonetypes/" + type.toString() + "/" + rock.toString()),
                        SoundType.STONE, OrePrefix.ore, Materials.Stone, "pickaxe", 0,
